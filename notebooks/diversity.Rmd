...
data_evenness <- data.frame(Evenness=diversity(count_data_normalized) / log(specnumber(count_data_normalized)))
data_shannon <- data.frame(Shannon=diversity(count_data_normalized, index = "shannon"))
